...
<head>
    ...
    <title>Cadastro de Funcionário - La Dolce Gelato</title>
...
<body>
    ...
    <div class="header-container">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="mb-0 fs-4 fw-bold"><i class="bi bi-person-plus me-2"></i> Cadastro de Funcionário</h2>
    ...
    <div class="container py-3">
        ...
        <?php if (isset($_SESSION['mensagem']) && isset($_SESSION['tipo_msg'])): ?>
            <div class="alert alert-<?= $_SESSION['tipo_msg'] === 'sucesso' ? 'success' : 'danger' ?> alert-dismissible fade show dashboard-alert" role="alert">
        ...
        <div class="dashboard-widget card reply-card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <span class="fw-bold">Informações do Funcionário</span>
                </div>
            </div>
            <div class="card-body">
                <form method="POST" action="<?= BASE_URL ?>funcionario/adicionar" enctype="multipart/form-data">
                    ...
                    <div class="message-info">
                        <div class="message-info-item">
                            ...
                            <input type="text" class="form-control mt-2" id="nome_funcionario"
                                name="nome_funcionario" required placeholder="Ex: João da Silva"
                                maxlength="100">
                        </div>
                        <div class="message-info-item">
                            <div class="message-info-label">CPF</div>
                            <input type="text" class="form-control mt-2" id="cpf_funcionario"
                                name="cpf_funcionario" required placeholder="000.000.000-00"
                    ...
                    <div class="message-info-item mb-3">
                        ...
                        <input type="text" class="form-control mt-2" id="endereco_funcionario"
                            name="endereco_funcionario" required placeholder="Rua, número, complemento">
                    </div>
                    ...
                    <div class="message-info">
                        <div class="message-info-item">
                            ...
                            <input type="text" class="form-control mt-2" id="bairro_funcionario"
                                name="bairro_funcionario" required placeholder="Nome do bairro">
                        </div>
                        <div class="message-info-item">
                            <div class="message-info-label">Cidade</div>
                            <input type="text" class="form-control mt-2" id="cidade_funcionario"
                                name="cidade_funcionario" required placeholder="Nome da cidade">
                        </div>
                    </div>
                    ...
                    <div class="message-info">
                        <div class="message-info-item">
                            ...
                            <input type="text" class="form-control mt-2" id="telefone_funcionario"
                                name="telefone_funcionario" required placeholder="(00) 00000-0000"
                                oninput="formatarTelefone(this)">
                        </div>
                        <div class="message-info-item">
                            <div class="message-info-label">Email</div>
                            <input type="email" class="form-control mt-2" id="email_funcionario"
                                name="email_funcionario" required placeholder="exemplo@email.com">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-1"></i> Salvar Funcionário
                        </button>
                    </div>
                </form>
            </div>
